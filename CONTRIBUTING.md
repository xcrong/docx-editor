# Contributing to @xcrong/docx-editor-react
...
```bash
bun run --filter '@xcrong/docx-editor-<pkg>' build
bun run api:extract
...
Open an issue at [github.com/xcrong/docx-editor/issues](https://github.com/xcrong/docx-editor/issues) with:
