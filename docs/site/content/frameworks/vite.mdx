---
title: 'Vite'
description: 'Build a Vite DOCX editor with React in minutes. No SSR caveats: install the package, mount the component, open a .docx, edit it, and download the result.'
category: 'Frameworks'
