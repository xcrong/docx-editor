...
The page stays static HTML; the editor is a single island with `client:only="react"`. This is the structure of [`examples/astro`](https://github.com/xcrong/docx-editor/tree/main/examples/astro):
...
- [Astro example on GitHub](https://github.com/xcrong/docx-editor/tree/main/examples/astro)
