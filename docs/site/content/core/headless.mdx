---
title: 'Headless API'
description: 'Reference for @xcrong/docx-editor-core/headless: DOCX parse and serialize, document creation, content controls, templates, watermarks, DocumentAgent.'
category: 'Core'
---
...
```ts
import { parseDocx, repackDocx } from "@xcrong/docx-editor-core/headless";
...
```ts
import { getParagraphs, getParagraphText } from "@xcrong/docx-editor-core/headless";
