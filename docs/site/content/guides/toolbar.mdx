---
title: 'Toolbar'
description: 'Customize the DOCX editor toolbar: hide built-in chrome, brand the title bar, append your own controls, or rebuild it from compound EditorToolbar parts.'
category: 'Guides'
