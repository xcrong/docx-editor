...
```ts
import { setContentControlContent, removeContentControl } from "@xcrong/docx-editor-core/headless";
...
```ts
import { setContentControlValue } from "@xcrong/docx-editor-core/headless";
...
```ts
import { createContentControl } from "@xcrong/docx-editor-core/headless";
...
```ts
import { addRepeatingSectionItem, removeRepeatingSectionItem } from "@xcrong/docx-editor-core/headless";
