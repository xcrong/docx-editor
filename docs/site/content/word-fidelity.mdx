...
[GitHub issue](https://github.com/xcrong/docx-editor/issues/new/choose).
...
- **Apache 2.0**, all packages. Contributions need a one-time [CLA](https://github.com/xcrong/docx-editor/blob/main/CLA.md).
- **SemVer** via changesets; all packages share one version number.
- The public API is tracked by [API Extractor snapshots](https://github.com/xcrong/docx-editor/tree/main/docs/api); CI fails on drift.
...
If a feature you need is Partial or missing, [open an issue](https://github.com/xcrong/docx-editor/issues/new/choose)
