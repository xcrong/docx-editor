...
This is the same wiring as [`examples/agent-chat-demo/`](https://github.com/xcrong/docx-editor/tree/main/examples/agent-chat-demo) in the repo, which you can run locally.
...
```bash
npm install @xcrong/docx-editor-react @xcrong/docx-editor-agents \
