...
<PackageStats name="@xcrong/docx-editor-agents" />
...
import { createReviewerBridge } from '@xcrong/docx-editor-agents';
...
| Subpath                        | Use when                                                                                  |
| ------------------------------ | ----------------------------------------------------------------------------------------- |
| `@xcrong/docx-editor-agents` | `DocxReviewer`, `agentTools`, `getToolSchemas`, `executeToolCall`, `createReviewerBridge` |
