...
`y-webrtc` uses free public signaling and needs zero infra, which makes it the right starter. We'll cover production providers (PartyKit, Liveblocks, Hocuspocus) below.
