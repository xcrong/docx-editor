...
For localStorage autosave with crash recovery, use the `useAutoSave` composable from `@xcrong/docx-editor-vue/composables` instead.
...
<template>
  <div class="layout">
    ...
    <!-- your chat pane: AgentChatLog / AgentComposer from
         @xcrong/docx-editor-agents/vue, or your own UI -->
  </div>
</template>
```
