...
```ts
import { DocxEditor, type DocxEditorRef, renderAsync } from '@xcrong/docx-editor-react';
import '@xcrong/docx-editor-react/styles.css';
```

```ts
import { DocxEditor, type DocxEditorRef, renderAsync } from '@xcrong/docx-editor-vue';
...
import type { Comment } from '@xcrong/docx-editor-core';
