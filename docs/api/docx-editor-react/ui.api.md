## API Report File for "@xcrong/docx-editor-react"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts

import { AgentResponse } from '@xcrong/docx-editor-core/types/agentApi';
import { AIAction } from '@xcrong/docx-editor-core/types/agentApi';
import { ColorValue } from '@xcrong/docx-editor-core/types/document';
import { createDefaultFindOptions } from '@xcrong/docx-editor-core/utils/findReplace';
import { createDefaultListState } from '@xcrong/docx-editor-core/utils/listState';
import { createSearchPattern } from '@xcrong/docx-editor-core/utils/findReplace';
import { CSSProperties } from 'react';
import { Document as Document_2 } from '@xcrong/docx-editor-core/types/document';
import { escapeRegexString } from '@xcrong/docx-editor-core/utils/findReplace';
import { findAllMatches } from '@xcrong/docx-editor-core/utils/findReplace';
import { findInDocument } from '@xcrong/docx-editor-core/utils/findReplace';
import { findInParagraph } from '@xcrong/docx-editor-core/utils/findReplace';
import { FindMatch } from '@xcrong/docx-editor-core/utils/findReplace';
import { FindOptions } from '@xcrong/docx-editor-core/utils/findReplace';
import { FindResult } from '@xcrong/docx-editor-core/utils/findReplace';
import { FontOption } from '@xcrong/docx-editor-core/utils/fontOptions';
import { formatPageRange as formatPrintPageRange } from '@xcrong/docx-editor-core';
import { getDefaultHighlightOptions } from '@xcrong/docx-editor-core/utils/findReplace';
import { getDefaultPrintOptions } from '@xcrong/docx-editor-core';
import { getMatchCountText } from '@xcrong/docx-editor-core/utils/findReplace';
import { HighlightOptions } from '@xcrong/docx-editor-core/utils/findReplace';
import { isEmptySearch } from '@xcrong/docx-editor-core/utils/findReplace';
import { isPrintSupported } from '@xcrong/docx-editor-core';
import { ListState } from '@xcrong/docx-editor-core/utils/listState';
import { openPrintWindow } from '@xcrong/docx-editor-core';
import { ParagraphAlignment } from '@xcrong/docx-editor-core/types/document';
import { ParsedClipboardContent } from '@xcrong/docx-editor-core/utils';
import { parsePageRange } from '@xcrong/docx-editor-core';
import { PrintOptions } from '@xcrong/docx-editor-core';
import * as React$1 from 'react';
import React__default from 'react';
import { ReactNode } from 'react';
import { replaceAllInContent } from '@xcrong/docx-editor-core/utils/findReplace';
import { replaceFirstInContent } from '@xcrong/docx-editor-core/utils/findReplace';
import { scrollToMatch } from '@xcrong/docx-editor-core/utils/findReplace';
import { SectionProperties } from '@xcrong/docx-editor-core/types/document';
import { SelectionContext } from '@xcrong/docx-editor-core/types/agentApi';
import { Style } from '@xcrong/docx-editor-core/types/document';
import { StyleType } from '@xcrong/docx-editor-core/types/document';
import { Table } from '@xcrong/docx-editor-core/types/document';
import { TableCell } from '@xcrong/docx-editor-core/types/document';
import { TabStop } from '@xcrong/docx-editor-core/types/document';
import { Theme } from '@xcrong/docx-editor-core/types/document';
import { TranslationKey } from '@xcrong/docx-editor-i18n';
import { triggerPrint } from '@xcrong/docx-editor-core';
