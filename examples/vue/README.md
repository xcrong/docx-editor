...
`@xcrong/docx-editor-vue` in a plain Vue 3 + Vite SPA. Same editor and same
...
| `src/main.ts`    | Vue app root + `@xcrong/docx-editor-vue/styles.css` |
...
```bash
npm install @xcrong/docx-editor-vue @xcrong/docx-editor-core
```

Unlike the React adapter, the Vue adapter ships a stylesheet you must import
once: `@xcrong/docx-editor-vue/styles.css`. Add the Material Symbols font
to `index.html`:
