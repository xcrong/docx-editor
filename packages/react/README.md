...
<p align="center">
  <a href="https://www.npmjs.com/package/@xcrong/docx-editor-react"><img src="https://img.shields.io/npm/v/@xcrong/docx-editor-react.svg?style=flat-square&color=3B5BDB" alt="npm version" /></a>
  <a href="https://www.npmjs.com/package/@xcrong/docx-editor-react"><img src="https://img.shields.io/npm/dm/@xcrong/docx-editor-react.svg?style=flat-square&color=3B5BDB" alt="npm downloads" /></a>
...
```tsx
import { DocxEditor, createEmptyDocument } from '@xcrong/docx-editor-react';
import '@xcrong/docx-editor-react/styles.css';
...
- `@xcrong/docx-editor-react` — `DocxEditor`, `renderAsync`, public types
- `@xcrong/docx-editor-react/ui` — toolbar primitives, pickers, sidebars, dialogs
- `@xcrong/docx-editor-react/hooks` — `useAutoSave`, `useTableSelection`, ...
- `@xcrong/docx-editor-react/dialogs` — dialog components barrel
- `@xcrong/docx-editor-react/plugin-api` — plugin host and plugin-facing types
- `@xcrong/docx-editor-react/styles` — style constants (`EDITOR_CSS_PATH`, z-index)
...
`@xcrong/docx-editor-core` is installed transitively. Add it to your `package.json` only if your own code imports core APIs directly. Strict installers like pnpm with peer auto-install disabled may also need the ProseMirror peers listed in `package.json`.

Examples: [Vite](https://github.com/xcrong/docx-editor/tree/main/examples/vite) · [Next.js](https://github.com/xcrong/docx-editor/tree/main/examples/nextjs) · [Remix](https://github.com/xcrong/docx-editor/tree/main/examples/remix) · [Astro](https://github.com/xcrong/docx-editor/tree/main/examples/astro)
