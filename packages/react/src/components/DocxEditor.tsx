...
import type { Document, Theme } from '@xcrong/docx-editor-core/types/document';
...
import { DocumentAgent } from '@xcrong/docx-editor-core/agent';
import { DefaultLoadingIndicator, DefaultPlaceholder, ParseError } from './DocxEditorHelpers';
import { type DocxInput } from '@xcrong/docx-editor-core/utils';
import type { FontDefinition, ScrollToParaIdOptions } from '@xcrong/docx-editor-core/utils';
import { useFontLifecycle } from '../hooks/useFontLifecycle';
import { useTableSelection } from '../hooks/useTableSelection';
import { useDocumentHistory } from '../hooks/useHistory';

// Extension system
import { createStarterKit } from '@xcrong/docx-editor-core/prosemirror/extensions';
import { ExtensionManager } from '@xcrong/docx-editor-core/prosemirror/extensions';
import {
...
import type { ContentControlFilter, ContentControlValue } from '@xcrong/docx-editor-core/agent';
import {
  acceptChange,
  rejectChange,
  acceptChangeById,
...
import { collectHeadings } from '@xcrong/docx-editor-core/utils';
import {
...
interface EditorState {
  ...
  paragraphTabs: import('@xcrong/docx-editor-core/types/document').TabStop[] | null;
...
// `@xcrong/docx-editor-core/docx` so React + Vue share the same
