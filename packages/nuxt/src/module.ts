 ...
 *
 * Nuxt module that wraps the `@xcrong/docx-editor-vue` adapter so Nuxt apps
...
const COMPOSABLES_SUBPATH = '@xcrong/docx-editor-vue/composables';
const STYLES_SUBPATH = '@xcrong/docx-editor-vue/styles.css';

// Public composables re-exported by `@xcrong/docx-editor-vue/composables`.
...
export interface ModuleOptions {
   ...
   * Set to `false` to import `@xcrong/docx-editor-vue/styles.css` yourself.
   * Defaults to `true`.
   */
