...
describe('updateCoreProperties dcterms:modified', () => {
  ...
  test('stays linear on malformed core.xml (no ReDoS)', () => {
    // A long run of unterminated `<dcterms:modified` openers used to backtrack
    // polynomially; it must now finish near-instantly.
